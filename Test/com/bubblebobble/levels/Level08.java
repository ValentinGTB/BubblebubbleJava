...
public class Level08 implements Level {
    public int getLevel() {
        return 8;
    }
    ...
    private void loadPlatforms(GameModel game) {
        ...
        game.addPlatform(new PlatformModel(250, Constants.MAX_HEIGHT - Constants.PLATFORM_HEIGHT * 6, 150, Constants.PLATFORM_HEIGHT));
        game.addPlatform(new PlatformModel(450, Constants.MAX_HEIGHT - Constants.PLATFORM_HEIGHT * 9, 150, Constants.PLATFORM_HEIGHT));
        game.addPlatform(new PlatformModel(650, Constants.MAX_HEIGHT - Constants.PLATFORM_HEIGHT * 12, 150, Constants.PLATFORM_HEIGHT));
    }
    ...
    private void loadPowerUps(GameModel game)
    {
        ...
        game.addPowerUp(new PowerUpModel(PowerUpType.DoublePoints, 300, 500, 40, 40));
        game.addPowerUp(new PowerUpModel(PowerUpType.Random, 750, 350, 40, 40));
    }
