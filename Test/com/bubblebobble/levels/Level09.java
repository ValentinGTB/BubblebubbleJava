...
public class Level09 implements Level {
    public int getLevel() {
        return 9;
    }
    ...
    private void loadPlatforms(GameModel game) {
        // piattaforma
        game.addPlatform(new PlatformModel(100, Constants.MAX_HEIGHT - Constants.PLATFORM_HEIGHT * 3, 300, Constants.PLATFORM_HEIGHT));
        game.addPlatform(new PlatformModel(500, Constants.MAX_HEIGHT - Constants.PLATFORM_HEIGHT * 6, 300, Constants.PLATFORM_HEIGHT));
        game.addPlatform(new PlatformModel(900, Constants.MAX_HEIGHT - Constants.PLATFORM_HEIGHT * 9, 300, Constants.PLATFORM_HEIGHT));
    }
    ...
    private void loadPowerUps(GameModel game)
    {
        ...
        game.addPowerUp(new PowerUpModel(PowerUpType.Health, 350, 500, 40, 40));
        game.addPowerUp(new PowerUpModel(PowerUpType.Speed, 700, 400, 40, 40));
    }
